...
class TestManualCategorizer(IsolatedAsyncioTestCase):
    ...
    async def test_continue_iteration(self):
        ...
        # Process first file and verify it
        ...
        self.notification.notify.assert_has_calls([
            ...
            mock.call(
                "2 files remaining to categorize",  # 2 files remaining is correct here
                level="info"
            )
        ], any_order=False)
        ...
        # Process second file and verify it
        ...
        self.notification.notify.assert_has_calls([
            ...
            mock.call(
                "1 file remaining to categorize",  # 1 file remaining is correct here
                level="info"
            )
        ], any_order=False)