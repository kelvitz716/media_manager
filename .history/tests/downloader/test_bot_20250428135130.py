...
class TestTelegramDownloader(IsolatedAsyncioTestCase):
    ...
    async def test_process_media_document(self):
        ...
        self.downloader.bot.download_file.return_value = AsyncIterator([b"test_data"])
    ...
    async def test_duplicate_download(self):
        ...
        await message.reply_to.assert_awaited_once_with(
    ...
    async def test_download_progress(self):
        ...
        self.downloader.bot.download_file.return_value = AsyncIterator(chunks)
