...
class TelegramDownloader:
    ...
    def __init__(self, config: Dict[str, Any], notification_service: NotificationService, categorizer):
        ...
        self.bot = AsyncTeleBot(self.config.get_config("telegram.bot_token"))
        self.client = TelegramClient(
            'telegram_bot_session',
            api_id=int(self.config.get_config("telegram.api_id")),
            api_hash=self.config.get_config("telegram.api_hash")
        )
        ...
        self.rate_limiter = AsyncRateLimiter(
            self.config.get_config("download.max_concurrent_downloads")
        )
        self.speed_limiter = SpeedLimiter(
            self.config.get_config("download.speed_limit")
        )
