...
class NotificationService:
    ...
    async def notify(self, message: str, wait_response: bool = False) -> Optional[str]:
        """
        ...
        Returns:
            Response text if wait_response is True, None otherwise
        """
        if not self.bot:
        ...
        try:
            ...
            if wait_response:
                return await self.wait_for_response(sent_message.message_id)
            return None
