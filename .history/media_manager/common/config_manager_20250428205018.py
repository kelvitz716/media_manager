...
DEFAULT_CONFIG = {
    "telegram": {
        ...
        "bot_token": "YOUR_BOT_TOKEN",  # Main bot token for downloads
    ...
    "notification": {
        "enabled": True,
        "method": "telegram",
        "bot_token": "YOUR_NOTIFICATION_BOT_TOKEN",  # Separate bot token for notifications
        "chat_id": ""    # Will be synced from telegram section
    },
    "logging": {
...
class ConfigManager:
    ...
    def _sync_credentials(self) -> None:
        ...
        # Only sync chat_id from telegram to notification
